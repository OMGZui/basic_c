...
#define Mac // "Windows" or "Linux" or "Mac"

#ifdef Mac
#include<termios.h>                                      //实现getch()、kbhit()                           //实现：检测键盘是否有输入      （这两个函数需要自行实现）
#endif // Mac

#ifdef Linux
#include<termio.h>                                      //实现getch()、kbhit()                         //实现：检测键盘是否有输入      （这两个函数需要自行实现）
#endif // Linux
...
#ifndef Windows        //以下是大神们提供的两个函数实现的方法，我只是个搬运工
